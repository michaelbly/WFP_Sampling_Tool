shinydashboardPlus::dashboardPage(
  ...
  shinydashboardPlus::dashboardHeader(
    ...
    title = "Focalizacion | COL"
  ),
  shinydashboardPlus::dashboardSidebar(
    collapsed = F,
    sidebarMenu(
      menuItem("Resumen", tabName = "1_introduction", icon = icon("home")),
      menuItem("Resultados", tabName = "2_resultados", icon = icon("chart-simple"), startExpanded = F), 
      menuItem("Verificacion", tabName = "3_verificacion", icon = icon("clipboard-check"), startExpanded = F)
    )
  ),
  
  #MOVE THE INPUT BOXES TO THE RIGHT TO ALIGN THEM WITH THE TEXT BOX
  dashboardBody(
    ...
    tabItems(
      ...
      ####################################################################
      #TABPANEL SAMPLINGFRAME
      ####################################################################
      tabItem(tabName = "2_resultados",
              fluidRow(
      ...
      #TABPANEL DOWNLOADS
      ####################################################################
      tabItem(tabName = "3_verificacion",
              sidebarLayout(
                sidebarPanel(
                  fluidRow(
